...
final class PasskeysStandalone extends PasskeysComponent implements HasActions, HasSchemas
{
    ...
    {
        return view('filament-passkeys::livewire.passkeys-standalone', data: [
